...
def test_arithmetic_operators():
    ...
    test_queries = [
        ...
        '[maxsize:1000000000][out:csv("number","length")];{{geocodeArea:"Berlin"}}->.searchArea;way["railway"="subway"](area.searchArea);make stat number=count(ways),length=sum(length())/1000;out;'
    ]
