...
def test_logical_operators():
    ...
    test_queries = [
        ...
        '[out:json][timeout:60];(relation["admin_level"]["wikidata"](if:t["admin_level"]>=5&&t["admin_level"]<=11)(-37.025032151632,174.48158132019,-36.713017687755,175.04669057312););out;>;out skel qt;'
    ]
