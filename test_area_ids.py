...
def test_area_multiple_ids():
    ...
    test_queries = [
        ...
        '[maxsize:2073741824];area(id:3600058437,3600058446,3600058447);way["highway"~"pedestrian|service|residential|track"]["highway_authority_ref"];out count;out tags;out center;'
    ]
